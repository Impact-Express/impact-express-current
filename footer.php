        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                ...
                <nav class="social-links">
                    ...
                    <div style="clear: both; padding-top: 20px; text-align: left;">
                        Awesome icons by <a href="https://fontawesome.com/license">Font Awesome.</a>
                    </div>
                </nav>
            </div>
        </div>
